# Generated by Django 3.2.5 on 2023-01-23 14:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(blank=True, choices=[('Bill', 'Bill'), ('Payment', 'Payment'), ('Allowance', 'Allowance'), ('Round off', 'Round off'), ('Paid out', 'Paid out')], max_length=50, null=True)),
                ...
                ('folio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='reservations.folio')),
                ...
                ('reservation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='reservations.reservation')),
                ...
                ('transaction_code', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='reservations.transactioncode')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
